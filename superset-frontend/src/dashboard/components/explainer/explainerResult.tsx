...
export const ExplainerResultModal = ({
  results,
}: ExplainerResultModalProps) => {
  console.log(results);
  return (
...
const EachExplainerResult = ({
  ...
  <div>
    ...
    <p>
      the explanation is {effectiveness.toFixed(5)} times better than random.
    </p>
  </div>
);
