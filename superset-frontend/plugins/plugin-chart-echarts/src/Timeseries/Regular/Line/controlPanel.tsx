...
const {
  ...
  zoomable,
  xAxisLabelRotation,
  autoGeneratedMinLimit,
  autoGeneratedMaxLimit,
} = DEFAULT_FORM_DATA;
  ...
  controlPanelSections: [
    ...
    sections.titleControls,
    {
      ...
      controlSetRows: [
        ...
        [
          {
            name: 'autoGeneratedMinLimit',
            config: {
              type: 'CheckboxControl',
              label: t('Min Auto'),
              default: autoGeneratedMinLimit,
              renderTrigger: true,
              description: t('Add a min limit for the Y-axis'),
            },
          },

          {
            name: 'autoGeneratedMaxLimit',
            config: {
              type: 'CheckboxControl',
              label: t('Max Auto'),
              default: autoGeneratedMaxLimit,
              renderTrigger: true,
              description: t('Add a max limit for the Y-axis'),
            },
          },
          {
            name: 'manualLimitBounds',
            config: {
              type: 'BoundsControl',
              label: t('Manual Limit'),
              default: [null, null],
              renderTrigger: true,
              description: t('Manually set min and max limits for the Y-axis'),
            },
          },
        ],
        ...legendSection,
