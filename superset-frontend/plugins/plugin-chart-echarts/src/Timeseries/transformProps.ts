...
export default function transformProps(
  ...
  // EXPERIMENTAL -- add more logic to the chart
  type limitData = {
  ...
  // if(manualLimitBounds[1]) {
  //   markLine.data.push({
  //     yAxis: manualLimitBounds[1],
  //     name: 'Max'
  //   });
  // }

  if (autoGeneratedMinLimit) {
    markLine.data.push({
      type: 'min',
      name: 'Min',
    });
  ...
  // if(manualLimitBounds[0]) {
  //       markLine.data.push({
  //         yAxis: manualLimitBounds[0],
  //         name: 'Min'
  //       });
  // }

  series.forEach((_item, i) => {
    series[i].markLine = markLine;
  });

  /// EXPERIMENTAL -- add more logic to the chart END
